...
public class Bosses {
    ...
    public static final int SHRIEKWING = 2398;
    public static final int HUNTSMAN = 2418;
    public static final int HUNGERING = 2383;
    public static final int SUN_KING = 2402;
    public static final int ARTIFICER = 2405;
    public static final int DARKVEIN = 2406;
    public static final int COUNCIL = 2412;
